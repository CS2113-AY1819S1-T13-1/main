...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), (ReadOnlyTaskBook) new ExpenseBook(), new UserPrefs());
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), (ReadOnlyTaskBook) model.getExpenseBook(), new UserPrefs());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();
